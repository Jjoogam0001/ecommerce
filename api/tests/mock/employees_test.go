...
func (m *MockEmployeeQueryRepository) DeleteEmployee(ctx context.Context, employeeNumber int) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DeleteEmployee", ctx, employeeNumber)
	ret0, _ := ret[0].(error)
	return ret0
}

// DeleteEmployee indicates an expected call of DeleteEmployee.
func (mr *MockEmployeeQueryRepositoryMockRecorder) DeleteEmployee(ctx, employeeNumber interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteEmployee", reflect.TypeOf((*MockEmployeeQueryRepository)(nil).DeleteEmployee), ctx, employeeNumber)
}

// FindEmployee mocks base method.
func (m *MockEmployeeQueryRepository) FindEmployee(ctx context.Context, employeeNumber int) (*model.Employee, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FindEmployee", ctx, employeeNumber)
...
func (mr *MockEmployeeQueryRepositoryMockRecorder) FindEmployee(ctx, employeeNumber interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FindEmployee", reflect.TypeOf((*MockEmployeeQueryRepository)(nil).FindEmployee), ctx, employeeNumber)
}
