...
func (m *MockCustomerQueryRepository) DeleteCustomer(ctx context.Context, customerNumber int) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DeleteCustomer", ctx, customerNumber)
	ret0, _ := ret[0].(error)
	return ret0
}

// DeleteCustomer indicates an expected call of DeleteCustomer.
func (mr *MockCustomerQueryRepositoryMockRecorder) DeleteCustomer(ctx, customerNumber interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteCustomer", reflect.TypeOf((*MockCustomerQueryRepository)(nil).DeleteCustomer), ctx, customerNumber)
}
